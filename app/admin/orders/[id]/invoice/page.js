...
export default function InvoicePrintPage() {
    ...
    return (
        <div className="bg-white min-h-screen text-black">
            {/* Print action bar */}
            <div className="print:hidden bg-neutral-100 p-4 flex flex-col sm:flex-row justify-between items-center border-b max-w-4xl mx-auto gap-4">
                ...
                <div className="flex gap-2">
                    <button 
                        ...
                        className="px-4 py-2 bg-neutral-800 text-white rounded hover:bg-black font-medium"
                        title="In Chrome, select Destination: Save as PDF"
                    >
                        Save as PDF
                    </button>
            ...
            {/* A4 Document Canvas */}
            <div className="max-w-4xl mx-auto p-8 sm:p-12 print:px-12 print:py-8 print:w-full print:max-w-none text-sm" style={{ width: '210mm', minHeight: '297mm' }}>
